...
class CreateTableHdAmountShareEleven20170918 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hd_amount_share_eleven', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('hd_amount_share_eleven', function (Blueprint $table) {
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::drop('hd_amount_share_eleven');
    }
}
