...
class CreateTableHdAmountShareMasterNew20180416 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hd_amount_share_master_new', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->timestamp('day')->nullable()->default(NULL)->comment("哪天首次领取");
        ...
        Schema::table('hd_amount_share_master_new', function (Blueprint $table) {
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::drop('hd_amount_share_master_new');
    }
}
