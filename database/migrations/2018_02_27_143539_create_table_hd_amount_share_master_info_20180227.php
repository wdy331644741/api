...
class CreateTableHdAmountShareMasterInfo20180227 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hd_amount_share_master_info', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('hd_amount_share_master_info');
    }
}
