...
class CreateTableHdAmountShareRichInfo20171108 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hd_amount_share_rich_info', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('hd_amount_share_rich_info');
    }
}
