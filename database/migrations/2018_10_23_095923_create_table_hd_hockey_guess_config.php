...
class CreateTableHdHockeyGuessConfig extends Migration
{
    ...
    public function up()
    {
        Schema::create('hd_hockey_guess_config', function (Blueprint $table) {
            ...
            $table->tinyInteger('open_status')->default(0)->comment('开奖状态0未开奖，1已公布结果，2开奖中，3已发送奖励,4已发送有未猜中');
