...
class CreateTableHdAmountShareMaster20180227 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hd_amount_share_master', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('hd_amount_share_master', function (Blueprint $table) {
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::drop('hd_amount_share_master');
    }
}
