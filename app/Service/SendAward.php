    ...
    static function beforeSendAward($activityInfo, $triggerData){
        ...
        switch ($activityInfo['alias_name']) {
            ...
            case 'perbai_investment':
                if(isset($triggerData['tag']) && !empty($triggerData['tag']) && $triggerData['tag'] == 'investment' && isset($triggerData['user_id']) && !empty($triggerData['user_id']) && $triggerData['novice_exclusive'] == 0){
