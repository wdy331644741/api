...
class OpenGiftJsonRpc extends JsonRpc
{
    ...
    protected $award_list = [
        ['alias_name' =>'cash',      'type' => 'cash'  ,'desp' => '688.88元现金',  'size' => 688.88, 'pro' => 1],
        ['alias_name' =>'cash',      'type' => 'cash'  ,'desp' => '68.88元现金',   'size' => 68.88, 'pro' => 10],
        ['alias_name' =>'cash',      'type' => 'cash'  ,'desp' => '1.88元现金',    'size' => 1.88, 'pro' => 477],
        ...
        switch ($award['alias_name']) {
            ...
            case 'increases':
                ...
                return [
                    ...
                    "product_id"            => "",
                    "platform_type"         => 0,
                    "limit_desc"            => $number."元起投，限3月及以上标",
                    "created_at"            => "2018-11-16 11:32:56",
                    "updated_at"            => "2018-11-16 11:32:56",
