...
//    'draw_number' => 1,
    ...
    'awards' => [//activity
        ['id'=>1, 'name' => '0.5元现金', 'alias_name' => 'xianjin0.5', 'type' => 'rmb', 'size'=>0.5],
        ['id'=>2,'name' => '1元现金', 'alias_name' => 'xianjin1', 'type' => 'rmb', 'size' => 1],
        ...
        ['id'=>6,'name' => '爱奇艺会员月卡', 'alias_name' => 'aiqiyi1', 'type' => 'virtual'],
        ['id'=>7,'name' => '2元现金', 'alias_name' => 'xianjin2', 'type' => 'rmb', 'size' => 2],
        ['id'=>8,'name' => '30元直抵红包', 'alias_name' => 'hongbao30', 'type' => 'activity'],
        ['id'=>9,'name' => '2%加息券', 'alias_name' => 'jiaxi2', 'type' => 'activity'],
        ['id'=>10,'name' => '5元现金', 'alias_name' => 'xianjin5', 'type' => 'rmb', 'size' => 5],
        ['id'=>11,'name' => '8元现金', 'alias_name' => 'xianjin8', 'type' => 'rmb', 'size' => 8],
        ['id'=>12,'name' => '爱奇艺会员季卡', 'alias_name' => 'aiqiyi3', 'type' => 'virtual'],
        ['id'=>13,'name' => '50元直抵红包', 'alias_name' => 'hongbao50', 'type' => 'activity'],
        ['id'=>14,'name' => '3%加息券', 'alias_name' => 'jiaxi3', 'type' => 'activity'],
        ['id'=>15,'name' => '18元现金', 'alias_name' => 'xianjin18', 'type' => 'rmb', 'size' => 18],
        ['id'=>16,'name' => '100元直抵红包', 'alias_name' => 'hongbao100', 'type' => 'activity'],
        ['id'=>17,'name' => '50JD卡', 'alias_name' => 'jingdongka50', 'type' => 'virtual'],
        ['id'=>18,'name' => '爱奇艺半年会员卡', 'alias_name' => 'aiqiyi6', 'type' => 'virtual'],
    ],
