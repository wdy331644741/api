...
<div class="container">
    <div class="about_sidebar clearfix">
        <div class="about_sidebar_div"><a href="/theme/about/" class="about_sidebar_a">关于我们</a><a href="{!! action('ContentController@getList',['type'=>'report']) !!}" class="about_sidebar_a">媒体报道</a><a href="{!! action('ContentController@getList',['type'=>'trends']) !!}" class="about_sidebar_a active">网利动态</a><a href="{!! action('ContentController@getList',['type'=>'notice']) !!}" class="about_sidebar_a">网站公告</a><a href="{!! action('ContentController@getList',['type'=>'classroom']) !!}" class="">理财课堂</a>
        </div>
    </div>
    <div class='section'>
            ...
            <div class='media_list'>
                ...
                <dl class='clearfix milestone_dd'>
                    <dd class='media_title'>
                        <a href="{!! action('ContentController@getDetail',['type'=>$type,'id'=>$dynamic->id]) !!}" target="_blank">
                            {!! $dynamic->title !!}
                        </a>
                    </dd>
                    <dd class='media_content postion_dd'>
                        <a href="{!! action('ContentController@getDetail',['type'=>$type,'id'=>$dynamic->id]) !!}" target="_blank" class='contentA'>{!! mb_substr(strip_tags($dynamic->content),0,130,'utf-8') !!}</a>
                        <a href="{!! action('ContentController@getDetail',['type'=>$type,'id'=>$dynamic->id]) !!}" target="_blank" class='link'>[详细介绍]</a>
                    </dd>
